    ...
    <!-- menu profile quick info -->
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            @if( Auth::user()->rol_id == 1 || Auth::user()->rol_id == 2 )
                @if(  Auth::user()->confirmed == 0 && Auth::user()->active == 1)
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Productos <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="{{route('crearListaProductos')}}">Crear lista de productos</a></li>
                                    <li><a href="{{route('listaProductoSugeridos')}}">Listas de productos</a></li>
                                </ul>
                            </li>
            ...
            @if (Auth::user()->rol_id == 3  && Auth::user()->confirmed == 0 && Auth::user()->active == 1)
                <div class="menu_section">
                    ...
                    <ul class="nav side-menu">
                        ...
                        <li><a href="{{route('ordencliente')}}"><i class="fa fa-product-hunt"></i>Solicitar pedido</a>
                        </li>
                        <li><a href="{{route('ultimasOrdenes')}}"><i class="fa fa-bullseye"></i>Mis ultimos pedidos</a>
                        </li>
                        <li><a href="{{route('estadoOrdenAcutal')}}"><i class="fa fa-dot-circle-o"></i>Estatus de mi
                                pedido actual</a></li>
                        <li><a href="{{route('sugerenciaProductos')}}"><i class="fa fa-check"></i>Sugerencias de
                                productos</a></li>
